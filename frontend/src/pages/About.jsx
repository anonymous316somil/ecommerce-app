    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-1/2 text-gray-600'>
          <p>
            Karobuy was born out of a passion for innovation and a desire to revolutionize the way people shop online.
          ...
          <p>
            Our mission at Karobuy is to empower customers with choice, convenience, and confidence.
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='flex-1 border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          ...
          <p className='text-gray-600'>
            Our dedicated support team is always ready to assist you before, during, and after your purchase.
          </p>
        </div>
      </div>
